(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/Users/mapa/Projects/terminal/content/about.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/terminal/content/bundle.js":[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.GITHUB = exports.CONTACT = exports.WELCOME = exports.SKILLS = exports.ABOUT = exports.HELP = undefined;
...
exports.HELP = _help.HELP;
exports.ABOUT = _about.ABOUT;
exports.SKILLS = _skills.SKILLS;
exports.WELCOME = _welcome.WELCOME;
exports.CONTACT = _contact.CONTACT;
exports.GITHUB = _github.GITHUB;

},{"./about.js":"/Users/mapa/Projects/terminal/content/about.js","./contact.js":"/Users/mapa/Projects/terminal/content/contact.js","./github.js":"/Users/mapa/Projects/terminal/content/github.js","./help.js":"/Users/mapa/Projects/terminal/content/help.js","./skills.js":"/Users/mapa/Projects/terminal/content/skills.js","./welcome.js":"/Users/mapa/Projects/terminal/content/welcome.js"}],"/Users/mapa/Projects/terminal/content/contact.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/terminal/content/github.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/terminal/content/help.js":[function(require,module,exports){
"use strict";
...
var HELP = {
  "title": "\n$$\\   $$\\ $$$$$$$$\\ $$\\       $$$$$$$\\        $$$$$$$\\  $$$$$$$$\\  $$$$$$\\  $$\\   $$\\ \n$$ |  $$ |$$  _____|$$ |      $$  __$$\\       $$  __$$\\ $$  _____|$$  __$$\\ $$ | $$  |\n$$ |  $$ |$$ |      $$ |      $$ |  $$ |      $$ |  $$ |$$ |      $$ /  \\__|$$ |$$  / \n$$$$$$$$ |$$$$$\\    $$ |      $$$$$$$  |      $$ |  $$ |$$$$$\\    \\$$$$$$\\  $$$$$  /  \n$$  __$$ |$$  __|   $$ |      $$  ____/       $$ |  $$ |$$  __|    \\____$$\\ $$  $$<   \n$$ |  $$ |$$ |      $$ |      $$ |            $$ |  $$ |$$ |      $$\\   $$ |$$ |\\$$\\  \n$$ |  $$ |$$$$$$$$\\ $$$$$$$$\\ $$ |            $$$$$$$  |$$$$$$$$\\ \\$$$$$$  |$$ | \\$$\\ \n\\__|  \\__|\\________|\\________|\\__|            \\_______/ \\________| \\______/ \\__|  \\__|\n",
  "text": ["\n  You can use any of the following commands, all of them are case-insensitive, \n  so don't worry how you spell!\n  - help\n  - about\n  - contact\n  - skills\n  - github\n\n  Hints:\n  - navigate through pages with left/right arrow\n  - up arrow will bring up the last used command (valid or not)\n\n  Psst...\n  --page={N}\n"]
};

exports.HELP = HELP;

},{}],"/Users/mapa/Projects/terminal/content/skills.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/terminal/content/welcome.js":[function(require,module,exports){
"use strict";
...
},{}],"/Users/mapa/Projects/terminal/node_modules/lodash/lodash.js":[function(require,module,exports){
(function (global){
/**
 * @license
...
},{}],"/Users/mapa/Projects/terminal/src/js/ajax.js":[function(require,module,exports){
'use strict';
...
},{}],"/Users/mapa/Projects/terminal/src/js/command.abstract.js":[function(require,module,exports){
'use strict';
...
var Command = function () {
  function Command(name) {
    var executes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  ...
  _createClass(Command, [{
    ...
    value: function run() {
      ...
      if (_lodash2.default.isString(this.executes)) {
        if (this.data) {
          if (!this.data.name) {
            this.data = Object.assign({ name: this.name }, this.data);
          }

          if (_lodash2.default.isFunction(this.callback)) {
            this.callback(params, this.data).then(function (modified) {
          ...
          return _ajax.Ajax.get(this.executes).then(function (response) {
            if (!response.name) {
              response = Object.assign({ name: _this.name }, response);
            }

            if (_lodash2.default.isFunction(_this.callback)) {
              _this.callback(params, response).then(function (modified) {
                callback(modified.params, modified.response);
              }).catch(function (e) {
                callback(null, params, e);
              });
            ...
            if (_lodash2.default.isFunction(_this.callback)) {
              _this.callback(false, params, error);
            } else {
...
},{"./ajax.js":"/Users/mapa/Projects/terminal/src/js/ajax.js","lodash":"/Users/mapa/Projects/terminal/node_modules/lodash/lodash.js"}],"/Users/mapa/Projects/terminal/src/js/command.component.js":[function(require,module,exports){
'use strict';
...
Vue.component('command-result', {
  ...
  computed: {
    humanFriendlyPage: function humanFriendlyPage() {
  ...
  methods: {
    ...
    runScript: function runScript() {
      var script = this.command.text[this.currentPage].match(/<script>(.|\n)*?<\/script>/gi);
      if (script) {
        script = script[0];
  ...
  watch: {
    user_name: function user_name(val) {
      var _this = this;

      figlet(val, 'Big Money-nw', function (err, text) {
        if (err) {
          _this.ascii_name = '';
          return;
        }

        _this.ascii_name = text;
      });
    },
    ...
    params: function params(_params) {
      if (_params.page) {
        this.currentPage = _params.page - 1;
      } else {
        this.currentPage = 0;
      }
  ...
  mounted: function mounted() {
    ...
    window.addEventListener('keyup', function (event) {
      if (event.keyCode == 37) {
        _this2.goToPage(_this2.currentPage - 1);
      }
...
},{"./figlet.js":"/Users/mapa/Projects/terminal/src/js/figlet.js"}],"/Users/mapa/Projects/terminal/src/js/command.list.js":[function(require,module,exports){
'use strict';
...
var _bundle = require('../../content/bundle.js');
...
var CommandList = [{
  ...
  alias: ['cls', 'cl'],
  exec: '',
  callback: function callback(params, response, error) {
    return new Promise(function (resolve, reject) {
      resolve({
        params: [],
        response: {}
  ...
  data: _bundle.WELCOME,
  exec: ''
}, {
  name: 'contact',
  alias: ['email', 'mail', 'linkedin', 'profile'],
  data: _bundle.CONTACT,
  exec: ''
}, {
  name: 'github',
...
},{"../../content/bundle.js":"/Users/mapa/Projects/terminal/content/bundle.js"}],"/Users/mapa/Projects/terminal/src/js/commander.js":[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CommandList = exports.Command = exports.CommanderInterface = undefined;
...
var _commandAbstract = require('./command.abstract.js');

var _commandList = require('./command.list.js');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var CommanderInterface = function () {
  function CommanderInterface() {
    var _this = this;

    _classCallCheck(this, CommanderInterface);

    this.commands = {};

    _lodash2.default.each(_commandList.CommandList, function (cmd) {
      _this.commands[cmd.name] = new _commandAbstract.Command(cmd.name, cmd.exec, cmd.callback, cmd.data);

      if (cmd.alias) {
        cmd.alias.forEach(function (name) {
          _this.commands[name] = _this.commands[cmd.name];
        });
      }
    });
  }

  _createClass(CommanderInterface, [{
    key: 'isValid',
    value: function isValid(command) {
      return _lodash2.default.has(this.commands, command.cmd || command);
    }
  }, {
    key: 'run',
    value: function run(command, callback) {
...
exports.CommanderInterface = CommanderInterface;
exports.Command = _commandAbstract.Command;
exports.CommandList = _commandList.CommandList;

},{"./command.abstract.js":"/Users/mapa/Projects/terminal/src/js/command.abstract.js","./command.list.js":"/Users/mapa/Projects/terminal/src/js/command.list.js","lodash":"/Users/mapa/Projects/terminal/node_modules/lodash/lodash.js"}],"/Users/mapa/Projects/terminal/src/js/figlet.js":[function(require,module,exports){
/*
...
},{}],"/Users/mapa/Projects/terminal/src/js/github.list.component.js":[function(require,module,exports){
'use strict';
...
Vue.component('github-list', {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _ajax.Ajax.get('https://api.github.com/users/mapolin/repos').then(function (result) {
        _this.repos = JSON.parse(result);
      }).catch(function (err) {
        console.log(err);
      });
    });
...
},{"./ajax.js":"/Users/mapa/Projects/terminal/src/js/ajax.js","./helper.js":"/Users/mapa/Projects/terminal/src/js/helper.js"}],"/Users/mapa/Projects/terminal/src/js/helper.js":[function(require,module,exports){
'use strict';
...
var Helper = {
  parseUserInput: function parseUserInput(input) {
    ...
    for (var i = 1; i < pieces.length; i++) {
      if (pieces[i].indexOf('--') == 0) {
        var arg = pieces[i].slice(2).split('=');
  ...
  setCursorPosition: function setCursorPosition(element, pos) {
    var elem = _lodash2.default.isString(element) ? document.querySelector(element) : element;
  ...
  _typer: function _typer(elem, text) {
    elem.textContent = text;
  },

  type: function type(elem, text, callback) {
    var _this = this;

    clearTimeout(this._typetimeout);

    var string = text.split('').reverse();
    var proggress = '';

    this._typertimeout = setInterval(function () {
      if (string.length > 0) {
        proggress += string.pop();
        _this._typer(elem, proggress);
      } else {
        clearTimeout(_this._typertimeout);
        callback && callback();
      }
    }, 100);
  }
...
},{"lodash":"/Users/mapa/Projects/terminal/node_modules/lodash/lodash.js"}],"/Users/mapa/Projects/terminal/src/js/index.js":[function(require,module,exports){
'use strict';

require('./input.component.js');

require('./command.component.js');

require('./github.list.component.js');

var _commander = require('./commander.js');

var _helper = require('./helper.js');

var Commander = new _commander.CommanderInterface();
...
var app = new Vue({
  ...
  computed: {
    renderCommands: function renderCommands() {
      var temp = [];
  ...
  methods: {
    parseCommand: function parseCommand(command) {
      var input = _helper.Helper.parseUserInput(command);
    ...
    selectCommand: function selectCommand(command) {
      var _this = this;

      Commander.run(command, function (params, response) {
        if (response) {
          _this.params = params;
          _this.activeCommand = response;
        }
      });
    }
  }
...
},{"./command.component.js":"/Users/mapa/Projects/terminal/src/js/command.component.js","./commander.js":"/Users/mapa/Projects/terminal/src/js/commander.js","./github.list.component.js":"/Users/mapa/Projects/terminal/src/js/github.list.component.js","./helper.js":"/Users/mapa/Projects/terminal/src/js/helper.js","./input.component.js":"/Users/mapa/Projects/terminal/src/js/input.component.js"}],"/Users/mapa/Projects/terminal/src/js/input.component.js":[function(require,module,exports){
'use strict';
...
Vue.component('input-field', {
  ...
  methods: {
    addCommand: function addCommand(event) {
      var elem = event.target ? event.target : event;
    ...
    goBack: function goBack(event) {
      ...
      if (this.history.length > 0) {
        ...
        _helper.Helper.setCursorPosition('.input', 1);
      }
    }
  },
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      _helper.Helper.type(input, 'welcome', function () {
        _this.addCommand(input);
      });
    });
  },
  watch: {
...
},{"./helper.js":"/Users/mapa/Projects/terminal/src/js/helper.js"}]},{},["/Users/mapa/Projects/terminal/src/js/index.js"])//# sourceMappingURL=index.js.map
